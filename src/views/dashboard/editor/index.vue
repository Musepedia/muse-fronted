...
<template>
  <div class="app-container center">
    ...
    <!-- 修改个人信息组件 -->
    <el-dialog v-model="setUserFormVisible" :close-on-click-modal="false" title="修改个人信息">
      <el-form ref="UserFormRef" :model="UserForm" :rules="UserFormRules" label-width="80px">
        ...
        <el-button :loading="editLoading" type="primary" @click="handleUserEdit">提交</el-button>
      </el-form>
    </el-dialog>
  </div>
</template>
